<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="EditLowongan.aspx.vb" Inherits="ProyekKetenagakerjaan.EditLowongan" MasterPageFile="~/MasterPageAdmin.Master" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="KelolaLowongan.aspx"><i class="fa fa-dashboard"></i> Kelola Lowongan</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Lowongan Anda Disini..</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <table class="nav-justified">
                ...
                <asp:Button ID="btnPost" runat="server" Text="SAVE" 
